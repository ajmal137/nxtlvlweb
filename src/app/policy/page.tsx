...
export default function PolicyPage() {
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl text-white">
            <h1 className="text-3xl font-bold font-orbitron mb-8 text-center text-primary">Legal Policies</h1>

            <div className="sticky top-20 bg-black/80 backdrop-blur-md p-4 mb-8 rounded-lg border border-white/10 z-10 flex flex-wrap gap-4 justify-center">
                <Link href="#terms" className="hover:text-primary transition-colors text-sm">Terms & Conditions</Link>
                <Link href="#privacy" className="hover:text-primary transition-colors text-sm">Privacy Policy</Link>
                <Link href="#shipping" className="hover:text-primary transition-colors text-sm">Shipping Policy</Link>
                <Link href="#refund" className="hover:text-primary transition-colors text-sm">Refund Policy</Link>
                <Link href="#return" className="hover:text-primary transition-colors text-sm">Return Policy</Link>
            </div>

            <div className="space-y-12">
                <section id="terms" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold font-orbitron mb-4 text-primary border-b border-primary/20 pb-2">Terms & Conditions</h2>
                    <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
                        ...
                        <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.nxtl.shop ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>
                        <p>The Platform is owned by nextlevel, a company incorporated under the Companies Act, 1956 with its registered office at 8-522-W, POTHUKALLU, Nilambur, Malappuram, Kerala-679334 (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our')..</p>
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                            ...
                            <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in [City] and [State].</li>
                ...
                <section id="privacy" className="scroll-mt-32">
                    ...
                    <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
                        ...
                        <h3 className="text-white font-bold text-lg mt-4">Sharing</h3>
                        ...
                        <h3 className="text-white font-bold text-lg mt-4">Security Precautions</h3>
                        ...
                        <h3 className="text-white font-bold text-lg mt-4">Data Deletion and Retention</h3>
                        ...
                        <h3 className="text-white font-bold text-lg mt-4">Changes to this Privacy Policy</h3>
                        ...
                        <h3 className="text-white font-bold text-lg mt-4">Grievance Officer</h3>
                        <div className="bg-white/5 p-4 rounded-md">
                            <p><strong>Name of the Office:</strong> SAIFUDHEEN</p>
                            <p><strong>Designation:</strong> PROPRIETOR</p>
                            <p><strong>Name and Address of the Company:</strong> NEXT LEVEL</p>
                            <p><strong>Building No./Flat No.:</strong> 8/522/W</p>
                            <p><strong>Road/Street:</strong> POTHUKALLU</p>
                            <p><strong>City/Town/Village:</strong> Nilambur</p>
                            <p><strong>District:</strong> Malappuram</p>
                            <p><strong>State:</strong> Kerala</p>
                            <p><strong>PIN Code:</strong> 679334</p>
                            <p className="mt-2"><strong>Contact us:</strong> Phone: Time: Monday - Friday(9:00 - 18:00)</p>
                        </div>
                    </div>
                </section>

                <section id="shipping" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold font-orbitron mb-4 text-primary border-b border-primary/20 pb-2">Shipping Policy</h2>
                    <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
                ...
                <section id="refund" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold font-orbitron mb-4 text-primary border-b border-primary/20 pb-2">Refund Policy</h2>
                    <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
                        <p>At Next Level, we value your satisfaction. This Refund Policy outlines the terms and conditions for refunds on products or services purchased through our Platform.</p>
                        <h3 className="text-white font-bold text-lg mt-4">Eligibility for Refunds</h3>
                        <ul className="list-disc pl-5 space-y-2">
                            <li>Refunds may be considered if the item received is damaged, defective, or significantly different from the description.</li>
                            <li>Requests for refunds must be raised within 7 days of delivery.</li>
                            <li>Products must be unused, in their original packaging, and accompanied by the original receipt or proof of purchase.</li>
                        </ul>
                        <h3 className="text-white font-bold text-lg mt-4">Refund Process</h3>
                        <ul className="list-disc pl-5 space-y-2">
                            <li>Once your return is received and inspected, we will notify you of the approval or rejection of your refund.</li>
                            <li>If approved, the refund will be processed, and a credit will automatically be applied to your original method of payment within 5-7 business days.</li>
                            <li>Shipping costs are non-refundable unless the return is due to an error on our part (e.g., wrong item sent).</li>
                        </ul>
                        <h3 className="text-white font-bold text-lg mt-4">Late or Missing Refunds</h3>
                        <p>If you haven’t received a refund yet, first check your bank account again. Then contact your credit card company or bank, as there is often some processing time before a refund is officially posted. If you’ve done all of this and still have not received your refund yet, please contact us at the details provided in the Grievance Officer section.</p>
                    </div>
                </section>

                <section id="return" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold font-orbitron mb-4 text-primary border-b border-primary/20 pb-2">Return Policy</h2>
                    <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
                        <p>We want you to be completely satisfied with your purchase. If you are not satisfied, you may return the product subject to the terms below.</p>
                        <h3 className="text-white font-bold text-lg mt-4">Return Window</h3>
                        <p>Items can be returned within 7 days from the date of delivery. Returns initiated after this period will not be accepted.</p>
                        <h3 className="text-white font-bold text-lg mt-4">Condition of Returned Items</h3>
                        <ul className="list-disc pl-5 space-y-2">
                            <li>Items must be unused, unwashed, and in the same condition that you received them.</li>
                            <li>Items must be in the original packaging with all tags, labels, and manuals intact.</li>
                            <li>Perishable goods, custom-made items, and gift cards are generally non-returnable.</li>
                        </ul>
                        <h3 className="text-white font-bold text-lg mt-4">How to Initiate a Return</h3>
                        <p>To initiate a return, please contact our support team or use the "My Orders" section on the Platform. You will be provided with instructions on where to ship the return. You will be responsible for paying for your own shipping costs for returning your item, unless the return is due to a defect or error on our part.</p>
                    </div>
                </section>
            </div>
        </div>
